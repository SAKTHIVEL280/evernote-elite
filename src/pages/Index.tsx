        ...
        >
          <div className="relative rounded-xl overflow-hidden h-full">
            ...
            >
              ...
              >
                <Link to="/editor">
                  <Button size="lg" className="bg-white text-black hover:bg-white/90 hover:scale-[1.03] active:scale-[0.98] px-6 md:px-7 h-11 md:h-12 text-sm font-medium rounded-xl group transition-all duration-200">
                    Start writing
                    <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform duration-300" />
                  </Button>
                </Link>
                <Link to="/tutorial">
                  <Button size="lg" variant="outline" className="border-white/50 bg-white/15 backdrop-blur-sm text-white hover:bg-white/25 hover:scale-[1.03] active:scale-[0.98] px-6 md:px-7 h-11 md:h-12 text-sm font-medium rounded-xl transition-all duration-200">
                    Learn MD
                  </Button>
                </Link>
              </motion.div>
